...
function getDemoData(type) {
    if (type === 'sheet1') {
        return [
            ...
            { name: 'Microsoft Corporation', details: 'Technology company based in Redmond, Washington.' }
        ];
    } else {
        return [
            { town: 'New York', details: 'Most populous city in the United States.' },
            { town: 'Los Angeles', details: 'Second most populous city in the US.' }
        ];
    }
}
...
function init() {
    ...
    console.log('MM Data Search v3 initialized');
}
